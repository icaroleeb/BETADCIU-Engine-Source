...
function onCreate()
    ...
    for c = 1, #DEFAULT_CHARACTERS do
        ...
        if getProperty(charName .. ".curCharacter") == "otis-speaker" then
    ...
    if #daModchartCharacters >= 1 then
        for c = 1, #daModchartCharacters do
            ...
            if getProperty(daModchartCharacters[c]..'.curCharacter') == "otis-speaker" then
