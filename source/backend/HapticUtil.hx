...
class HapticUtil
{
   ...
   */
  public static function vibrate(period:Float = CoolUtil.DEFAULT_VIBRATION_PERIOD, duration:Float = CoolUtil.DEFAULT_VIBRATION_DURATION,
      amplitude:Float = CoolUtil.DEFAULT_VIBRATION_AMPLITUDE, sharpness:Float = CoolUtil.DEFAULT_VIBRATION_SHARPNESS,
      ?targetHapticsModes:Array<HapticsMode>):Void
  {
    ...
    final amplitudeValue = (amplitude * Preferences.hapticsIntensityMultiplier).clamp(0, CoolUtil.MAX_VIBRATION_AMPLITUDE);
  ...
  public static function increasingVibrate(startAmplitude:Float, targetAmplitude:Float, tweenDuration:Float = 1):Void
  {
    ...
    amplitudeTween = FlxTween.num(startAmplitude, targetAmplitude, tweenDuration, {
      onComplete: function(_)
      {
        ...
        vibrate(CoolUtil.DEFAULT_VIBRATION_PERIOD, CoolUtil.DEFAULT_VIBRATION_DURATION, finalAmplitude);
      }
    }, function(currentAmplitude:Float)
    {
      vibrate(0, CoolUtil.DEFAULT_VIBRATION_DURATION / 10, currentAmplitude);
    });
  }
  ...
  {
    return {
      period: CoolUtil.DEFAULT_VIBRATION_PERIOD,
      duration: CoolUtil.DEFAULT_VIBRATION_DURATION,
      amplitude: CoolUtil.DEFAULT_VIBRATION_AMPLITUDE,
      sharpness: CoolUtil.DEFAULT_VIBRATION_SHARPNESS
    };
  }
