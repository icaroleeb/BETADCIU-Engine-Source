...
// This BaseStage is basictly with array without putting stageVar for Lazy People who don't wanna set stageVar.set(sprite);
...
class BaseStage extends FlxBasic
{
	...
	public var baseStageObjects:Array<FlxBasic> = [];
	...
	{
		if (baseStageObjects != null) {
			for (obj in baseStageObjects) {
				if (obj != null) {
