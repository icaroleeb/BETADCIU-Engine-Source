...
class DropShadowShader extends FlxShader
{
  ...
  /**
   * The FlxAnimate that the shader should get the frame data from.
   * Needed to keep the drop shadow shader in the correct bounds and rotation.
   */
  public var attachedSprite(default, set):FlxAnimate;
  ...
  function set_attachedSprite(spr:FlxAnimate):FlxAnimate
  {
    attachedSprite = spr;
