...
class HSVShader extends FlxRuntimeShader
{
  ...
  {
    super(openfl.utils.Assets.getText((Paths.fragment('hsv', false))));
    #if debug FlxG.debugger.addTrackerProfile(new TrackerProfile(HSVShader, ['hue', 'saturation', 'value'])); #end
    hue = h;
    saturation = s;
    value = v;
  }
