...
class MainMenuState extends MusicBeatState
{
	...
	public static var betadciuVer:String = "1.0.1"; // This is also used for Discord RPC
	public static var plusVer:String = "1.0"; // This is also used for Discord RPC
	...
	override function create()
	{
		...
		add(fnfVer);
		var betadciuVer:FlxText = new FlxText(12, FlxG.height - 24, 0, "BETADCIU Engine Plus+ "+plusVer+" (Rework Build: v"+betadciuVer+")", 12); // Reworked sounds better than "Reboot"
