...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		add(fnfVer);
		var betadciuVer:FlxText = new FlxText(12, FlxG.height - 24, 0, "BETADCIU Engine Plus+ (Rework Build Pre-Release: v"+betadciuVer+") v"+plusVer, 12); // Reworked sounds better than "Reboot"
