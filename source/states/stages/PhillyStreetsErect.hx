...
class PhillyStreetsErect extends BaseStage
{
	...
	public static var rainShaderStartIntensity:Float = 0.01;
	public static var rainShaderEndIntensity:Float = 0.02;
	...
	override function create()
	{
		...
		var phillyHighwayLights:BGSprite = new BGSprite('phillyStreets/erect/phillyHighwayLights', 122, 201, 0.8, 0.8);
		...
		var phillyHighway:BGSprite = new BGSprite('phillyStreets/erect/phillyHighway', -23, 105, 0.8, 0.8);
		...
		if(!ClientPrefs.data.lowQuality)
		{
			...
			stageVars.set('grey2', grey2);
			add(grey2);
		}

		mist4 = new FlxBackdrop(Paths.image('phillyStreets/erect/mistBack'), FlxAxes.X, 0, 0);
