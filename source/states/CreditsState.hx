...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['BETADCIU Engine Plus+ Credits'],
			['Icaro Lee',			'icarolee',			'Main Programmer of BETADCIU Engine Plus+, \nPorted legacy Main Menu, Some options and Fixed some Stuff','https://x.com/Icarofnf','5F0000'],
			[""],
